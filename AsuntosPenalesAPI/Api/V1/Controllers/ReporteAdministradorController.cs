...
using AsuntosPenalesAPI.Model.Entities.Events.ReporteAdministrador;
...
{
    [ApiController]
    [Route("sicoj/asuntos-penales/api/v1/Reporte-Administrador/asuntos-penales")]
    public class ReporteAdministradorController : ControllerBase
    {
        ...
        private readonly IReporteAdministradorService _ReporteAdministradorService;

        public ReporteAdministradorController(ILogger<OficialPartesController> logger, IRedisClient redisClient, IReporteAdministradorService reporteAdministradorService)
        {
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
            _redisClient = redisClient ?? throw new ArgumentNullException(nameof(redisClient));
            _ReporteAdministradorService = reporteAdministradorService ?? throw new ArgumentNullException(nameof(reporteAdministradorService));
        }
        ...
        public async Task<IActionResult> Exportar_Excel([FromQuery] QueryFilters request)
        {
            try
            {
                ...
                Filters.MapFiltersQuery(request, filters);
                    ...
                    var datos = await _ReporteAdministradorService.ExportarReporteGeneral(
                    ...
                    using var workbook = ReporteAdministradorEvents.GenerarExcelClosedXmlGeneral(datos);
