...
using AsuntosPenalesAPI.Model.Entities.Events.ReporteAdministradorUA;
...
{
    [ApiController]
    [Route("sicoj/asuntos-penales/api/v1/reporte-administrador-ua/asuntos-penales")]
    public class ReporteAdministradorUAController : ControllerBase
    {
        private readonly ILogger<OficialPartesController> _logger;
        private readonly IRedisClient _redisClient;
        private readonly IReporteAdministradorUAService _ReporteAdministradorUAService;

        public ReporteAdministradorUAController(ILogger<OficialPartesController> logger, IRedisClient redisClient, IReporteAdministradorUAService reporteAdministradorUAService)
        {
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
            _redisClient = redisClient ?? throw new ArgumentNullException(nameof(redisClient));
            _ReporteAdministradorUAService = reporteAdministradorUAService ?? throw new ArgumentNullException(nameof(reporteAdministradorUAService));
        }
        ...
        public async Task<IActionResult> Exportar_Excel([FromQuery] QueryFilters request)
        {
            try
            {
                ...
                Filters.MapFiltersQuery(request, filters);
                    ...
                    var datos = await _ReporteAdministradorUAService.ExportarReporteGeneral(
                    ...
                    using var workbook = ReporteAdministradorUAEvents.GenerarExcelClosedXmlGeneral(datos);
