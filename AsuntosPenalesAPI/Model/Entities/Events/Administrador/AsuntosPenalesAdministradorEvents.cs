...
{
    public class AsuntosPenalesAdministradorEvents
    {
        public static void UpdateGuardar(
        ...
        {
            Guard.ValidateStringEmpty(ref noExpedienteCadido!, "No. Expediente Cadido");
            ...
            Guard.CatalogValue(ref idSubadministracion, "Unidad Realiza solicitud", false);
            ...
            entity.id_admin_controla = idUnidadAdministrativa;
        ...
        public static void UpdateGuardarHistorico(
            ref AsuntosPenales entity,
            string? noExpedienteCadido,
            string? oficioSolicitud,
            DateTime fechaRecepcion,
        ...
        )
        {
            ...
            if (entity.id_estado_tarea != EnumEstadoTarea.PENDIENTE_DE_ASIGNAR.GetHashCode())
                throw new Exception(
                    "El asunto penal no se puede turnar debido a que no tiene en el estado de la tarea: pendiente de asignar."
                );

            if (entity.id_estado_procesal != EnumEstadoProcesal.EN_ESTUDIO.GetHashCode())
                throw new Exception(
                    "El asunto penal no se puede turnar debido a que no tiene en el estado procesal: en estudio."
                );

            entity.id_estado_tarea = EnumEstadoTarea.ASIGNADO.GetHashCode();
            entity.id_estado_procesal = EnumEstadoProcesal.EN_ESTUDIO.GetHashCode();
            entity.numero_empleado = noEmpleado;
            entity.numero_empleado_adm = usuarioMidificacion;
        }

        public static AsuntosPenalesReasignar UpdateReasignarAdministrador(
            ref AsuntosPenales entity,
        ...
        )
        {
            switch (entity.id_estado_procesal)
            {
                case (int?)EnumEstadoProcesal.CONCLUIDO_POR_IMPROCEDENCIA:
                    throw new Exception(
                        "El asunto penal no puede ser reasingnado por que tiene el estado de procesal: concluido por improcedencia."
                    );
                case (int?)EnumEstadoProcesal.CONCLUIDO_REMITIDO:
                    throw new Exception(
                        "El asunto penal no puede ser reasingnado por que tiene el estado de procesal: concluido remitido."
                    );
                default:
                    break;
            }
            switch (entity.id_estado_tarea)
            {
                case (int)EnumEstadoTarea.CONCLUIDO_POR_IMPROCEDENCIA:
                    throw new Exception(
                        "El asunto penal no puede ser reasingnado por que tiene el estado de tarea: concluido por improcedencia."
                    );
                case (int?)EnumEstadoTarea.PENDIENTE_DE_TURNAR:
                    throw new Exception(
                        "El asunto penal no puede ser reasingnado por que tiene el estado de tarea: pendiente de turnar."
                    );
                case (int?)EnumEstadoTarea.PENDIENTE_DE_ASIGNAR:
                    throw new Exception(
                        "El asunto penal no puede ser reasingnado por que tiene el estado de tarea: pendiente de asignar."
                    );
                case (int)EnumEstadoTarea.CONCLUIDO_REMITIDO:
                    throw new Exception(
                        "El asunto penal no puede ser reasingnado por que tiene el estado de tarea: concluido remitido."
                    );
                default:
                    break;
            }
            ...
            AsuntosPenalesReasignar entityReasignacion =
                new()
                {
                    ...
                    id_unidad_administrativa_reasignador =
                        idUnidadAdministrativaReasignador.GetValueOrDefault(),
                    id_subadministracion_reasignador =
                        idSubadministrativaReasignador.GetValueOrDefault(),
                    id_unidad_administrativa_reasignado =
                        idUnidadAdministrativaReasignado.GetValueOrDefault(),
                    id_subadministracion_reasignado =
                        idSubadministracioReasignado.GetValueOrDefault(),
                    id_estado_procesal_previo = entity.id_estado_procesal,
                    id_estado_procesal_nuevo = EnumEstadoProcesal.EN_ESTUDIO.GetHashCode(),
                    id_estado_tarea_nuevo = EnumEstadoTarea.PENDIENTE_DE_ASIGNAR.GetHashCode()
                };

            return entityReasignacion;
        }

        public static AsuntosPenalesReasignar UpdateReasignarAbogado(
            ref AsuntosPenales entity,
            string? usuarioModificacion,
        ...
        )
        {
            ...
            entity.id_estado_tarea = EnumEstadoTarea.REASIGNADO.GetHashCode();
            entity.usuario_modificacion = usuarioModificacion;
            ...
            AsuntosPenalesReasignar entityReasignacion =
                new()
                {
                    ...
                    id_subadministracion_reasignado =
                        idSubadministracioReasignado.GetValueOrDefault(),
                    id_estado_procesal_previo = entity.id_estado_procesal,
                    id_estado_tarea_nuevo = EnumEstadoTarea.REASIGNADO.GetHashCode(),
                    id_estado_procesal_nuevo = entity.id_estado_procesal
                };
        ...
        )
        {
            ...
            if (
                ...
                throw new Exception(
                    "La autorización no se puede turnar debido a que no tiene en el estado procesal: en estudio o activo"
                );
