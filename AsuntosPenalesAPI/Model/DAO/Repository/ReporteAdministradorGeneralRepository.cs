...
{
    public class ReporteAdministradorGeneralRepository : IReporteAdministradorGeneralRepository
    {
        #region Variables
        ...
        #region Constructor
        public ReporteAdministradorGeneralRepository(ISqlTools database)
        {
