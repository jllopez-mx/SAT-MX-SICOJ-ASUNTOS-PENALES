...
{
    public class ReporteAdministradorUAService : IReporteAdministradorUAService
    {
        private readonly IReporteAdministradorUARepository _repositoryReporteAdministradorUA;
        private readonly IRedisClient _redisClient;

        public ReporteAdministradorUAService(IConfiguration configuration, IReporteAdministradorUARepository repository, IRedisClient redisClient)
        {
            _repositoryReporteAdministradorUA = repository ?? throw new ArgumentNullException(nameof(repository));
