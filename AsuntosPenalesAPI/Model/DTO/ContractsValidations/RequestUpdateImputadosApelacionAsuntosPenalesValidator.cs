...
{
    public class RequestUpdateImputadosApelacionAsuntosPenalesValidator: AbstractValidator<RequestUpdateApelacion>
    {
        public RequestUpdateImputadosApelacionAsuntosPenalesValidator()
        {
            ...
            RuleFor(c => c.id)
            .NotNull()
            .WithMessage("El id de apelación es requerido.")
            .NotEmpty()
            .WithMessage("El id de apelación es requerido.");
