...
{
    public class RequestCreateAsuntosPenalesValidator: AbstractValidator<RequestCreateAsuntosPenales>
    {
        public RequestCreateAsuntosPenalesValidator(){
            ...
            RuleFor(c => c.id_admin_controla)
                .GreaterThan(0)
                .NotNull()
                .WithMessage("La administracion que controla es requerida");
